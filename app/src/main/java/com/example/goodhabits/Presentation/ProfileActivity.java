...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Profile> list = ProfileStorage.getProfileStorage();
        String[] profileInfo = {list.get(0).getName(), list.get(0).getEmail()};
        fillProfileActivity(profileInfo);
    }


    // Function to populate all the TextView in this Activity
