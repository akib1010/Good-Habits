...
public class Habit {
    ...
    private boolean type;//Type of Habit, If true then it is a "Good Habit" else it is a "Bad Habbit"
    ...
    private int minute;//Used to handle the minute of the hour for the acivity
    ...
    //Returns Type of Habit, If true then it is a "Good Habit" else it is a "Bad Habbit"
